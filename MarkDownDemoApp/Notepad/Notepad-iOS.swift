...
public class Notepad: UITextView {
    ...
    convenience public init(frame: CGRect, themeFile: NotepadTheme) {
        self.init(frame: frame, textContainer: nil)
        let theme = Theme(themeFile.asText)
    ...
    convenience public init(frame: CGRect, theme: NotepadTheme) {
        self.init(frame: frame, themeFile: theme)
    }
