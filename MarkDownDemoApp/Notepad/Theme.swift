...
public enum NotepadTheme {
    case base16TomorrowDark
    case base16TomorrowLight
    case bluesClues
    case oneDarkCustom
    case oneDark
    case oneLightCustom
    ...
    var asText: String {
        switch self {
        case .base16TomorrowDark:    return "base16-tomorrow-dark"
        case .base16TomorrowLight:   return "base16-tomorrow-light"
        case .bluesClues:            return "blues-clues"
        case .oneDarkCustom:         return "one-dark-custom"
        case .oneDark:               return "one-dark"
        case .oneLightCustom:        return "one-light-custom"
        case .oneLight:              return "one-light"
        case .solarizedDark:         return "solarized-dark"
        case .solarizedLight:        return "solarized-light"
        case .systemMinimal:         return "system-minimal"
        }
    }
}
